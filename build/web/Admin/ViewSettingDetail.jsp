                        ...
                        <form action="UpdateSettingURL" method="post" id="form1" >
                            ...
                            <div class="modal-body">					
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="name" id="username" value="${dataa['Name']}" required readonly>
                                    <span class="form-message text-danger" id="username-error"></span>
                                </div>

                                <div class="form-group">
                                    <label for="roleSelect">Type</label>
                                    <select class="form-control" id="typeSelect" name="typeId" required disabled>

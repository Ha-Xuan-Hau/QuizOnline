...
<html>
    ...
    <div class="a">
        ...
        %>
        <div style="margin-right: 100px; font-size: xx-large;font-family: sans-serif "><%=title%></div>
        <a href="javascript:history.back()" class="return-link">Return</a></div>

</head>
<body style="background-color: #6d9eff">
    <div class="container" >
    ...
    <div class="button-container" style="background-color: #6d9eff">

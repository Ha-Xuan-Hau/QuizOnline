...
public class MyApplicationConstants {
    ...
    public class LoginFeature {
        ...
        public static final String NEW_PASSWORD_PAGE = "newPasswordPage";
        public static final String OTP_PAGE = "otpPage";
    }
    ...
    public class QuestionSetFeature {
        ...
        public static final String VIEW_MY_SET_PAGE = "viewMyQuestionSetPage";
        public static final String VIEW_MY_SET_DETAIL_PAGE = "viewMyQuestionSetDetailPage";
...
//        public static final String QUESTION_SET_PAGE = "questionSetPage";
    ...
    public class ClassExamFeature {
        ...
        public static final String CLASS_EXAM_LIST_ACTION = "classExamListAction";
        ...
        public static final String EXAM_PAGE = "examPage";
        public static final String ATTEMP_EXAM_ACTION = "attemptExamAction";
        public static final String ATTEMP_REVIEW_ACTION = "attemptReviewAction";
        public static final String ATTEMP_REVIEW_PAGE = "attemptReviewPage";
        public static final String IMPORT_EXCEL_PAGE = "inportExcelPage";
    ...
    public class AdminFeature {
        ...
        public static final String ADMIN_UPDATE_PROFILE_PAGE = "adminUpadteProfilePage";
    ...
    public class TeacherExamFeature {
        ...
        public static final String CREATE_EXAM_BY_BANK = "createExamByBankPage";
    }
}

...
<html lang="en">
    ...
    <body style="background-color: #eeeeee">
        ...
        <h2 style="color: black; text-align: left; margin-left: 5%;">
        ...
        <div  style="display: flex">
            <c:if test="${not empty questionSetListAll}"> 
                ...
                <div class="Containt" style="width: 90%;">
                    <div id="paginationControls" style="display: flex ;align-content: center;justify-content: center; width: 70%">
                ...
                <ul class="SG" id="questionSetListAll">
                    <c:forEach var="questionSetAll" items="${questionSetListAll}">
                        <li class="sgLi" onclick="redirectToSet('${questionSetAll.getSetId()}')" style="">
                            <div class="box" style="display: flex">
                                <div style="width: 50%; background-color: #f7cec8; border-radius: 10px" ><img style=" max-width: 100%; max-height: 100%; object-fit: contain;" src="${pageContext.request.contextPath}/Class/images/sub.jpg" width="500px" alt="alt"/></div>
                                <div style="width: 50%" >

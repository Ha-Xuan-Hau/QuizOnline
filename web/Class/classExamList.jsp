            ...
            <li>
                    <c:if test="${accId == teacher.getAccountId()}">
                        <div class="button-group">
                            <a class="custom-btn" href="NewExamURL">New Exam</a>
                            <a class="custom-btn" href="ExamByQuestionSetURL">Exam by Bank</a>
                            <a class="custom-btn" href="ExcelURL">Import Exam</a>
                        </div>
                    </c:if>  
            </li>

...
//        //student
    ...
    throws ServletException, IOException {
       DAOUser dao = new DAOUser();
        ...
        DAOTeacher daoTc = new DAOTeacher();
        Teacher tc = new Teacher();
        tc.setAccountId(Integer.parseInt(request.getParameter("accId")));
        tc.setPhone(request.getParameter("phonee"));
        tc.setTeacherName(request.getParameter("tcName"));
        daoTc.updateTeacher(tc);
        DAOStudent daoSt = new DAOStudent();
        Student St = new Student();
        
        String phone = request.getParameter("phoneee");
        St.setAccountId(Integer.parseInt(request.getParameter("accId")));
        St.setStudentName(request.getParameter("stName"));
        St.setDoB(request.getParameter("dob"));
        St.setPhone(request.getParameter("phoneee"));
        daoSt.UpdateStudent(St);
